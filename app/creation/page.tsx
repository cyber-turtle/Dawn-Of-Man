...
export default function CreationPage() {
  ...
  const initializeScene = () => {
    ...
    const adamTextureUrl = 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg/1200px-Michelangelo_-_Creation_of_Adam_%28cropped%29.jpg';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#030303] text-[#E0D4C3] overflow-x-hidden">
        <div ref={loaderRef} className="fixed top-0 left-0 w-full h-full bg-black z-[1000] flex justify-center items-center text-white font-syncopate transition-opacity duration-1000">
        ...
        <div ref={navDotsRef} className="nav-progress fixed right-8 top-1/2 -translate-y-1/2 flex flex-col gap-3 z-[100] mix-blend-difference" />
        ...
        <style jsx global>{`
          ...
          .bg-noise {
            background: url('data:image/png;base64,');
          }
